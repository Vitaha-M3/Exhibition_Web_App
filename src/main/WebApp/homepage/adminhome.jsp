                ...
                <c:otherwise>
                    ...
                    <table align="center">
                        ...
                        <c:if test="${showQuantityTickForExpo}">
                            <h4 align="center">Куплено билетов по экспозициям</h4>
                                <tr>
                                    <th>ID Експозиции</th>
                                    <th>Тема</th>
                                    <th>Дата завершения</th>
                                    <th>Купленных билетов</th>
                                    <th>Выручка</th>
                                </tr>
                        ...
                        <c:if test="${showForUserStatistic}">
                            <h4 align="center">Статистика по пользователям</h4>
                            <tr>
                                <th>ID пользователя</th>
                                <th>Имя</th>
                                <th>Email</th>
                                <th>Купленных билетов</th>
                                <th>ID експозиций которые посетил</th>
                                <th>Выручка</th>
                            </tr>
