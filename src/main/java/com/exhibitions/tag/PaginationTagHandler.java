 ...
 * This Tag Handler create as test
 * For this test create discriptor mytag.tld in directory WEB_INF/tld
 * @see javax.servlet.jsp.tagext.JspTag
 */
public class PaginationTagHandler implements Tag {
    ...
    public int doEndTag() throws JspException {
        ...
        String page = request.getParameter("pageTable");
